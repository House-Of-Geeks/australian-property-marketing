...
const testimonials = [
  {
    ...
    name: "Mark Brennan", title: "Principal", company: "Brennan Property Group", location: "Newcastle",
  ...
  },
  {
    ...
    name: "Sarah Chen", title: "Director", company: "Alliance Residential", location: "Melbourne Inner East",
  ...
  },
  {
    ...
    name: "David Holloway", title: "Owner", company: "Holloway & Partners", location: "Brisbane Northside",
  ...
  },
  {
    ...
    name: "Rachel Morrison", title: "Principal", company: "Morrison Real Estate", location: "Geelong",
  ...
  },
  {
    ...
    name: "James Whitfield", title: "Director", company: "Whitfield Property", location: "Adelaide Hills",
          ...
          <div className={styles.main}>
            ...
            <div className={styles.author}>
              ...
              <div className={styles.authorInfo}>
                ...
                <span className={styles.authorTitle}>{testimonials[activeIndex].title}, {testimonials[activeIndex].company}</span>
                <span className={styles.authorLocation}>{testimonials[activeIndex].location}</span>
              </div>
          ...
          <div className={styles.nav}>
            {testimonials.map((t, index) => (
              <button key={index} className={`${styles.navBtn} ${activeIndex === index ? styles.active : ''}`} onClick={() => setActiveIndex(index)}>
                ...
                <span className={styles.navCompany}>{t.company}</span>
